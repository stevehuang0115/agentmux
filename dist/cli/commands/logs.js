...
async function showProjectLogs(agentmuxHome, lines) {
    try {
...
async function showCommunicationLogs(agentmuxHome, lines) {
...
async function showSchedulerLogs(agentmuxHome, lines) {
    console.log(chalk.cyan('\n⏰ Scheduler Activity:'));
    try {
...
async function followLogs(agentmuxHome) {
