...
export class TaskAssignmentMonitorService extends EventEmitter {
    ...
    MAX_CONCURRENT_JOBS = 10; // Prevent resource exhaustion
     ...
     */
    async stopMonitoring(monitoringId, reason = 'manual_stop') {
...
//# sourceMappingURL=task-assignment-monitor.service.js.map