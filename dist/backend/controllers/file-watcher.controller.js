...
export class FileWatcherController {
     ...
     */
    async getWatchedProjects(req, res) {
        try {
     ...
     */
    async startWatchingAll(req, res) {
        try {
     ...
     */
    async startScheduledCommits(req, res) {
        try {
     ...
     */
    async stopScheduledCommits(req, res) {
        try {
            const { projectPath } = req.body;
            if (!projectPath) {
                res.status(400).json({ error: 'Project path is required' });
     ...
     */
    async getScheduledProjects(req, res) {
        try {
...
//# sourceMappingURL=file-watcher.controller.js.map