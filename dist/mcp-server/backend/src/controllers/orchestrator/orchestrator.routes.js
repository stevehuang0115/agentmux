...
import { getOrchestratorCommands, executeOrchestratorCommand, sendOrchestratorMessage, sendOrchestratorEnter, setupOrchestrator, stopOrchestrator, getOrchestratorHealth, assignTaskToOrchestrator, updateOrchestratorRuntime } from './orchestrator.controller.js';
/**
 ...
 */
export function createOrchestratorRouter(context) {
    const router = Router();
