          ...
          if (staleTeam) {
            ...
            for (const staleMember of staleTeam.members) {
              ...
              if (freshMember) {
                ...
                if ((staleMember as any).lastActivityCheck) {
                  (freshMember as any).lastActivityCheck = (staleMember as any).lastActivityCheck;
                }
                if (staleMember.workingStatus !== undefined) {
                  freshMember.workingStatus = staleMember.workingStatus;
                }
                if ((staleMember as any).lastTerminalOutput !== undefined) {
                  (freshMember as any).lastTerminalOutput = (staleMember as any).lastTerminalOutput;
                } else if ('lastTerminalOutput' in staleMember && (staleMember as any).lastTerminalOutput === undefined) {
                  // Handle explicit deletion of lastTerminalOutput
                  delete (freshMember as any).lastTerminalOutput;
                }
