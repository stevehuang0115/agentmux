...
// Type helpers
export type AgentStatus = typeof AGENTMUX_CONSTANTS.AGENT_STATUSES[keyof typeof AGENTMUX_CONSTANTS.AGENT_STATUSES];
export type WorkingStatus = typeof AGENTMUX_CONSTANTS.WORKING_STATUSES[keyof typeof AGENTMUX_CONSTANTS.WORKING_STATUSES];
