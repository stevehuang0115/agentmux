...
import * as scheduledMessagesHandlers from './scheduled-messages.handlers.js';
...
describe('Scheduled Messages Handlers', () => {
  ...
  describe('runScheduledMessage', () => {
    ...
    it('should handle orchestrator target team', async () => {
      ...
      expect(mockTmuxService.sendMessage).toHaveBeenCalledWith('agentmux-orc', 'Hello orchestrator');
    });
