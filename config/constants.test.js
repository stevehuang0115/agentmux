 ...
 */
import { AGENTMUX_CONSTANTS, MCP_CONSTANTS, WEB_CONSTANTS, TIMING_CONSTANTS, MESSAGE_CONSTANTS, ENV_CONSTANTS, } from './constants.js';
        ...
        describe('ROLES', () => {
            ...
            test('should have display names for all roles', () => {
                Object.values(AGENTMUX_CONSTANTS.ROLES).forEach((role) => {
                    ...
                    expect(typeof AGENTMUX_CONSTANTS.ROLE_DISPLAY_NAMES[role]).toBe('string');
                });
            });
