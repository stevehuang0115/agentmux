...
```bash
bash {{AGENT_SKILLS_PATH}}/marketplace-publish/execute.sh '{"action":"validate","skillPath":"{{PROJECT_PATH}}/config/skills/agent/my-skill"}'
```
...
```bash
bash {{AGENT_SKILLS_PATH}}/marketplace-publish/execute.sh '{"action":"publish","skillPath":"{{PROJECT_PATH}}/config/skills/agent/my-skill"}'
```
...
```bash
bash {{AGENT_SKILLS_PATH}}/marketplace-publish/execute.sh '{"action":"publish-remote","skillPath":"{{PROJECT_PATH}}/config/skills/agent/my-skill"}'
```
...
```bash
bash {{AGENT_SKILLS_PATH}}/marketplace-publish/execute.sh '{"action":"list-submissions"}'
```

Filter by status:
```bash
bash {{AGENT_SKILLS_PATH}}/marketplace-publish/execute.sh '{"action":"list-submissions","status":"pending"}'
```
