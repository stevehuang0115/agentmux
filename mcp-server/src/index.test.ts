...
describe('MCP Server Index', () => {
  ...
  describe('port parsing', () => {
    ...
    it('should handle edge case port values', () => {
      ...
      let port = parseInt(process.env.MCP_PORT || '3001');
      expect(port).toBe(1);

      // Test maximum valid port  
      process.env.MCP_PORT = '65535';
  ...
  describe('shebang and node execution', () => {
    it('should have proper shebang for node execution', async () => {
      ...
      const path = '/Users/yellowsunhy/Desktop/projects/justslash/agentmux/mcp-server/src/index.ts';
