...
describe('ThreadListPanel', () => {
  ...
  describe('new thread button', () => {
    it('renders the new thread button when onCreateThread is provided', () => {
    ...
    it('does not render the new thread button when onCreateThread is not provided', () => {
      render(
        <ThreadListPanel
          conversations={mixedConversations}
          selectedConversationId={null}
      ...
      expect(screen.queryByTestId('new-thread-button')).not.toBeInTheDocument();
    });

    it('calls onCreateThread when the button is clicked', () => {
      const mockOnCreateThread = vi.fn();
    ...
    it('has accessible aria-label on the new thread button', () => {
      const mockOnCreateThread = vi.fn();
